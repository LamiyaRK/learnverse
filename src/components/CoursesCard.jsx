...
export default function CoursesCard({course}) {
    const {title,thumbnail,price,rating,lessonsCount,enrolled,instructorName,shortDescription}=course;
  return (
    <div className='space-y-1 '>
      <Image src={thumbnail} width={500} height={500} className='h-[400px] w-full object-cover object-center' alt={title}/>
      <div className='p-5 space-y-1'>
      <div className='flex justify-between space-y-1'>
        <p><i className='text-primary'>by</i> <span>{instructorName}</span></p>
